...
import { CATEGORIES, type Playlist } from '@src/data/content';
import {
  getCategoryRoute,
...
// Walks parentPlaylistId links to build [root, ..., parent] for breadcrumbs.
...
export default function PlaylistPage() {
  ...
  const playlist = playlists.find(
    (item) => item.category === categoryMeta.slug && item.id === playlistId,
  );
